...
- (Task<id> *)spawnTask: (id (^)(void))block [[direct]];
- (Task<id> *)spawnTask: (id (^)(void))block name: (OFString *nillable)name [[direct]];
- (Task<id> *)spawnTaskInChildTaskGroup: (id (^)(AsyncTaskGroup *taskGroup))block [[direct]];
- (Task<id> *)spawnTaskInChildTaskGroup: (id (^)(AsyncTaskGroup *taskGroup))block name: (OFString *nillable)name [[direct]];
- (Task<OFArray<id> *> *)spawnAllTasks: (OFArray<id (^)(void)> *)blocks [[direct]];
- (Task<OFArray<id> *> *)spawnAllTasks: (OFArray<id (^)(void)> *)blocks name: (OFString *nillable)name [[direct]];
