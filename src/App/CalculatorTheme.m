                                   ...
                                   onPress: (void (^nillable)(void))onPress
{
    ...
    return [AUIFrame width: [AUI axisGrow: 0]
                     height: [AUI axisFit: 0]
                      child: [AUIButton title: $assert_nonnil(title)
                                       variant: variant
...
{
    if (label == nilptr or value == nilptr)
        @throw [OFInvalidArgumentException exception];

    AUIBoxProps props = [self metricTileProps];
    ...
    return [AUIBox layout: props.layout
               background: props.backgroundColor
                   ...
                   border: props.border
                 children: @[
        [AUIText string: $assert_nonnil(label) style: [self metricLabelStyle]],
        [AUIText string: $assert_nonnil(value) style: [self metricValueStyle]]
    ]];
}
