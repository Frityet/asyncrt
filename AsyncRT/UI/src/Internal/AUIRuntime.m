...
- (instancetype)initWithApplication: (AUIApplication *)application
{
    ...
    _renderer = [[AUIRenderer alloc] initWithApplication: application];
    _interactionEngine = [[AUIInteractionEngine alloc] init];
    _textInput = [[AUITextInputEngine alloc] init];
