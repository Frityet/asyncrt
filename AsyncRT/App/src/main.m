...
@interface BooruFetchCommand : OFObject <CLICommand>

@property(readonly, nonatomic) CLIOption<OFString *> *booru;
@property(readonly, nonatomic) CLIOption<OFString *> *apiKey;
@property(readonly, nonatomic) CLIOption<OFString *> *userID;
@property(readonly, nonatomic) CLIOption<OFString *> *tags;
@property(readonly, nonatomic) CLIOption<OFString *> *exclude;
@property(readonly, nonatomic) CLIOption<OFNumber *> *page;
@property(readonly, nonatomic) CLIOption<OFNumber *> *limit;
@property(readonly, nonatomic) CLIOption<OFNumber *> *scale;
@property(readonly, nonatomic) CLIOption<OFNumber *> *columns;
@property(readonly, nonatomic) CLIOption<OFNumber *> *maxEdge;
@property(readonly, nonatomic) CLIOption<OFNumber *> *jpegQuality;
@property(readonly, nonatomic) CLIOption<OFString *> *graphicsProtocol;
@property(readonly, nonatomic) CLIOption<OFIRI *> *baseIRI;
@property(readonly, nonatomic) CLIOption<OFString *> *cacheDir;
@property(readonly, nonatomic) CLIOption<OFNumber *> *cacheOnly;
...
{
    self = [super init];
    _booru = [[[[CLIOption optional: OFString.class]
                       withLongName: @"booru"]
                           withHelp: @"Service to query: gelbooru or realbooru"]
                   withDefaultValue: @"gelbooru"];

    _apiKey = [[[CLIOption optional: OFString.class]
    ...
    _userID = [[[CLIOption optional: OFString.class]
...
- (OFString *)_credentialFromOption: (CLIOption<OFString *> *)option
...
- (id)applicationDidFinishLaunchingAsync: (OFNotification *)notification taskGroup: (AsyncTaskGroup *)taskGroup
{
    ...
    auto parser = [[ArgumentParser<BooruFetchCommand *> alloc] initWithCommand: command];
