...
- (AUIViewNode *)renderViewNode
{
    ...
    return [AUIViewBoxNode boxNodeWithKey: @"keypad-panel"
                   ...
                   interactionConfiguration: nilptr
                                 children: @[
        [CalculatorViewNodes columnNodeWithKey: @"keypad-title" gap: 4 children: @[
            [CalculatorViewNodes textNode: @"Keypad" style: [CalculatorTheme sectionTitleStyle]]
        ]],
        [CalculatorViewNodes rowNodeWithKey: @"memory-row" gap: 10 children: @[
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"memory-clear", .title = @"MC", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = _model.hasMemoryValue, .onPress = ^{ [_model memoryClear]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"memory-recall", .title = @"MR", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = _model.hasMemoryValue, .onPress = ^{ [_model memoryRecall]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"memory-store", .title = @"MS", .variant = AUIControlVariantPrimary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model memoryStore]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"memory-add", .title = @"M+", .variant = AUIControlVariantPrimary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model memoryAdd]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"memory-subtract", .title = @"M-", .variant = AUIControlVariantPrimary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model memorySubtract]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"insert-ans", .title = @"ANS", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = _model.hasLastAnswer, .onPress = ^{ [_model appendAnswerReference]; [self _refresh]; } })]
        ]],
        [CalculatorViewNodes rowNodeWithKey: @"edit-row" gap: 10 children: @[
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"clear", .title = @"C", .variant = AUIControlVariantDanger, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model clearExpression]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"clear-all", .title = @"AC", .variant = AUIControlVariantDanger, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model clearAll]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"backspace", .title = @"Back", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = (_model.expression.length > 0 or _model.hasLastAnswer), .onPress = ^{ [_model backspace]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"toggle-sign", .title = @"+/-", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model toggleSign]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"percent", .title = @"%", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyPercent]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"factorial", .title = @"!", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFactorial]; [self _refresh]; } })]
        ]],
        [CalculatorViewNodes rowNodeWithKey: @"functions-row-a" gap: 10 children: @[
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"sin", .title = @"sin", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"sin"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"cos", .title = @"cos", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"cos"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"tan", .title = @"tan", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"tan"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"sinh", .title = @"sinh", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"sinh"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"cosh", .title = @"cosh", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"cosh"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"tanh", .title = @"tanh", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"tanh"]; [self _refresh]; } })]
        ]],
        [CalculatorViewNodes rowNodeWithKey: @"functions-row-b" gap: 10 children: @[
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"asin", .title = @"asin", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"asin"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"acos", .title = @"acos", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"acos"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"atan", .title = @"atan", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"atan"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"ln", .title = @"ln", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"ln"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"log", .title = @"log", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"log"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"exp", .title = @"exp", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"exp"]; [self _refresh]; } })]
        ]],
        [CalculatorViewNodes rowNodeWithKey: @"functions-row-c" gap: 10 children: @[
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"sqrt", .title = @"sqrt", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"sqrt"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"square", .title = @"x^2", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applySquare]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"reciprocal", .title = @"1/x", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyReciprocal]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"abs", .title = @"abs", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"abs"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"rand", .title = @"rand", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendRandomFunction]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"power", .title = @"^", .variant = AUIControlVariantPrimary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendOperator: @"^"]; [self _refresh]; } })]
        ]],
        [CalculatorViewNodes rowNodeWithKey: @"digits-row-a" gap: 10 children: @[
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-7", .title = @"7", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"7"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-8", .title = @"8", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"8"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-9", .title = @"9", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"9"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"open-paren", .title = @"(", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendOpenParenthesis]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"close-paren", .title = @")", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendCloseParenthesis]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"divide", .title = @"/", .variant = AUIControlVariantPrimary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendOperator: @"/"]; [self _refresh]; } })]
        ]],
        [CalculatorViewNodes rowNodeWithKey: @"digits-row-b" gap: 10 children: @[
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-4", .title = @"4", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"4"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-5", .title = @"5", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"5"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-6", .title = @"6", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"6"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"constant-pi", .title = @"pi", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendConstantNamed: @"pi"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"constant-e", .title = @"e", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendConstantNamed: @"e"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"multiply", .title = @"*", .variant = AUIControlVariantPrimary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendOperator: @"*"]; [self _refresh]; } })]
        ]],
        [CalculatorViewNodes rowNodeWithKey: @"digits-row-c" gap: 10 children: @[
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-1", .title = @"1", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"1"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-2", .title = @"2", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"2"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-3", .title = @"3", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"3"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"floor", .title = @"floor", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"floor"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"ceil", .title = @"ceil", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"ceil"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"minus", .title = @"-", .variant = AUIControlVariantPrimary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendOperator: @"-"]; [self _refresh]; } })]
        ]],
        [CalculatorViewNodes rowNodeWithKey: @"digits-row-d" gap: 10 children: @[
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-0", .title = @"0", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"0"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"digit-00", .title = @"00", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDigits: @"00"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"decimal", .title = @".", .variant = AUIControlVariantNeutral, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendDecimalPoint]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"round", .title = @"round", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model applyFunctionNamed: @"round"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"constant-tau", .title = @"tau", .variant = AUIControlVariantSecondary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendConstantNamed: @"tau"]; [self _refresh]; } })],
            [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){ .key = @"plus", .title = @"+", .variant = AUIControlVariantPrimary, .size = AUIControlSizeLarge, .isEnabled = true, .onPress = ^{ [_model appendOperator: @"+"]; [self _refresh]; } })]
        ]],
        [CalculatorViewNodes buttonNodeFromSpec: ((CalculatorButtonSpec){
            .key = @"evaluate",
            .title = @"Evaluate",
