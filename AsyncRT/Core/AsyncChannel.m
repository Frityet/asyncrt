...
- (instancetype)initWithChannel: (AsyncChannel *)channel value: (id)value scheduler: (AsyncScheduler *)scheduler task: (AsyncTask *)task [[designated_initailiser]];
...
- (instancetype)initWithChannel: (AsyncChannel *)channel scheduler: (AsyncScheduler *)scheduler task: (AsyncTask *)task [[designated_initailiser]];
- (instancetype)initWithScheduler: (AsyncScheduler *)scheduler task: (AsyncTask *)task OF_UNAVAILABLE;
- (bool)_finishOnce [[direct]];
...
- (instancetype)initWithChannel: (AsyncChannel *)channel value: (id)value scheduler: (AsyncScheduler *)scheduler task: (AsyncTask *)task
{
...
- (instancetype)initWithChannel: (AsyncChannel *)channel scheduler: (AsyncScheduler *)scheduler task: (AsyncTask *)task
{
    self = [super initWithScheduler: scheduler task: task];
    _channel = channel;
    _lock = [OFMutex mutex];
