...
@interface AsyncUIColorValue : OFObject
...
@property(class, readonly, nonatomic) AsyncUIColorValue *clear;
@property(class, readonly, nonatomic) AsyncUIColorValue *white;
@property(class, readonly, nonatomic) AsyncUIColorValue *black;
