...
@interface AsyncUIException : OFException
...
@interface AsyncUIInitializationException : AsyncUIException @end
[[subclassing_restricted, direct_members]]
@interface AsyncUIRenderException : AsyncUIException @end
