...
static void task_await(AsyncTaskGroup *rootScope)
{
    ...
    [AsyncRuntimeTestSupport assertCondition: ([awaitableTask.await isEqual: @"awaitable-task"]) message: (@"Task.await should use the runtime task await implementation")];
}
...
ASYNC_RUNTIME_ASYNC_TEST(task_await)
