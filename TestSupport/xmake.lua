local async_runtime_test_suites = {
    {
        ...
        group = "utilities",
        files = {"tests/AsyncRuntimeTests.m", "tests/Common/TestCasesUtilities.m"}
    },
    {
        name = "argument_parser",
        class = "AsyncRuntimeArgumentParserTests",
        group = "utilities/argument-parser",
        deps = {"AsyncRTApplicationTerminal"},
        files = {"tests/AsyncRuntimeTests.m", "tests/Terminal/TestCasesArgumentParser.m"}
    },
    {
        name = "sync",
        ...
        group = "sync",
        timeout = 20,
        files = {"tests/AsyncRuntimeTests.m", "tests/Core/TestCasesSync.m"}
    },
    {
        name = "async_task",
    ...
    },
    {
        ...
        group = "ui",
        timeout = 30,
        deps = {"AsyncRTApplicationUI"},
        files = {"tests/AsyncRuntimeTests.m", "tests/ApplicationUI/TestCasesApplicationUI.m"}
    },
    {
        name = "app",
        class = "AsyncRuntimeAppTests",
        group = "app",
        deps = {"AsyncRTExampleUISupport"},
        files = {"tests/AsyncRuntimeTests.m", "tests/ExamplesUI/TestCasesExamplesUI.m"}
    },
    {
        name = "database",
        class = "AsyncRuntimeDatabaseTests",
        group = "database",
        deps = {"AsyncRTDatabase", "AsyncRTDatabaseProviderSQLite"},
        files = {"tests/AsyncRuntimeTests.m", "tests/Database/TestCasesDatabase.m"}
    },
    {
        name = "coverage",
...
target("AsyncRTTestSupport", function ()
    ...
    add_deps("AsyncRTCore", "AsyncRTNetworkingHTTP", { public = true })
    add_includedirs("..", { public = true })
    add_headerfiles("(TestSupport.h)", {install = false})
