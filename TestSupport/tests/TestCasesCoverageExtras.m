...
- (void)_resumeTask: (AsyncTask *)task [[direct]];
@end
...
@property(nonatomic) enum AsyncCoroutineStatus status;
...
- (void)test_runtime_internal_description_coverage
{
    ...
    auto namedTaskGroup = [[AsyncTaskGroup alloc] initWithScheduler: scheduler
                                                    ...
                                                    parentTaskGroup: nilptr
                                                               name: @"named-scope"
                                                           deadline: nilptr];
    auto namedTask = [[AsyncTask alloc] initWithScheduler: scheduler
                                           taskGroup: nilptr
                                                name: @"named-task"
                                               block: ^id {
                                                   return @"unused";
                                               }];
    auto unnamedTask = [[AsyncTask alloc] initWithScheduler: scheduler
                                             taskGroup: nilptr
                                                  name: nilptr
                                                 block: ^id {
                                                     return @"unused";
                                                 }];
    auto task = [AsyncTask resolved: @"ready"];
    ...
    auto taskReturnedNilException = [[AsyncTaskReturnedNilException alloc] initWithTask: namedTask];
    auto taskCancelledException = [[AsyncTaskCancelledException alloc] initWithTask: namedTask];
    ...
    OTAssert(([[AsyncTask describeStatus: AsyncTaskStatus_REJECTED] isEqual: @"REJECTED"]), @"Tasks should describe rejected state explicitly");
    OTAssert(([[AsyncTask describeExecutionState: AsyncTaskExecutionState_READY] isEqual: @"READY"]
        and [[AsyncTask describeExecutionState: AsyncTaskExecutionState_RUNNING] isEqual: @"RUNNING"]
        and [[AsyncTask describeExecutionState: AsyncTaskExecutionState_WAITING] isEqual: @"WAITING"]
        and [[AsyncTask describeExecutionState: AsyncTaskExecutionState_RESOLVED] isEqual: @"RESOLVED"]), @"Tasks should describe every execution state explicitly");
    ...
    OTAssert(([awaitOutsideTaskException.description containsString: @"outside a AsyncTask"]), @"AsyncTaskAwaitOutsideTaskException should describe the task requirement");
    ...
    OTAssert(([taskReturnedNilException.description containsString: @"returned nilptr"]), @"AsyncTaskReturnedNilException should describe nil return failures");
    OTAssert(([taskCancelledException.description containsString: @"cancellation checkpoint"]), @"AsyncTaskCancelledException should describe cancellation checkpoints");
    ...
    OTAssert(([namedTask.description containsString: @"named-task"]
        and [unnamedTask.description containsString: @"<AsyncTask"]), @"AsyncTask descriptions should render both named and unnamed tasks");
...
- (void)test_task_continuation_and_scope_internal_branches
{
    [self runAsyncBlock: ^(AsyncTaskGroup *rootScope) {
            ...
            auto mappedRejected = [[AsyncTask rejected: [[TestRejectionException alloc] init]]
                mapOnScheduler: scheduler
                      transform: ^id(id) {
                          return @"unreachable";
                      }];
            auto flatMappedRejected = [[AsyncTask rejected: [[TestRejectionException alloc] init]]
                flatMapOnScheduler: scheduler
                             transform: ^AsyncTask *(id) {
                                 return [AsyncTask resolved: @"unreachable"];
                             }];
            auto recoveredResolved = [[AsyncTask resolved: @"kept"]
                recoverOnScheduler: scheduler
                           handler: ^id(OFException *) {
                               return @"changed";
                           }];
            auto flatRecoveredResolved = [[AsyncTask resolved: @"still-kept"]
                flatRecoverOnScheduler: scheduler
                               handler: ^AsyncTask *(OFException *) {
                                   return [AsyncTask resolved: @"changed"];
                               }];
            auto spawnedWithoutName = [rootScope spawnTask: ^id {
                return @"spawned";
            }];
            auto throwingTask = [[AsyncTask alloc] initWithScheduler: scheduler
                                                      taskGroup: nilptr
                                                           name: @"throws"
                                                          block: ^id {
            ...
            @try {
                (void)[AsyncTask all: (OFArray<AsyncTask *> *)[OFArray arrayWithObject: @"bad"]];
            } @catch (OFInvalidArgumentException *) {
                caughtInvalidAll = true;
            }

            @try {
                (void)[AsyncTask race: (OFArray<AsyncTask *> *)[OFArray arrayWithObject: @"bad"]];
            } @catch (OFInvalidArgumentException *) {
            ...
            OTAssert((caughtMappedReject and caughtFlatMappedReject), @"AsyncTask continuations should propagate rejected inputs across map and flatMap");
            ...
            OTAssert((caughtInvalidAll and caughtInvalidRace), @"AsyncTask collection helpers should reject non-task inputs");
            OTAssert(([[spawnedWithoutName await] isEqual: @"spawned"]), @"AsyncTask groups should support the spawnTask: convenience overload");
            OTAssert(([[rootScope performInChildTaskGroup: ^id(AsyncTaskGroup *) {
                return @"child-result";
            }] isEqual: @"child-result"]), @"AsyncTask groups should support the performInChildTaskGroup: convenience overload");
...
- (void)test_scheduler_channel_private_branches
{
    ...
    auto cancelledTaskGroup = [[AsyncTaskGroup alloc] initWithScheduler: scheduler ownerTask: (AsyncTask *)cancelledTaskGroupOwner parentTaskGroup: nilptr name: @"cancelled" deadline: nilptr];
    auto finishedTaskGroup = [[AsyncTaskGroup alloc] initWithScheduler: scheduler ownerTask: (AsyncTask *)finishedTaskGroupOwner parentTaskGroup: nilptr name: @"finished" deadline: nilptr];
    auto deadlineTaskGroup = [[AsyncTaskGroup alloc] initWithScheduler: scheduler ownerTask: (AsyncTask *)deadlineTaskGroupOwner parentTaskGroup: nilptr name: @"deadline" deadline: [OFDate dateWithTimeIntervalSinceNow: 1]];
    auto taskGroup = [[AsyncTaskGroup alloc] initWithScheduler: scheduler ownerTask: (AsyncTask *)ownerTask parentTaskGroup: nilptr name: @"scope" deadline: nilptr];
    auto channel = [[AsyncChannel alloc] initWithCapacity: 1];
    ...
    invalidCompletionCoroutine.status = AsyncCoroutineStatus_DEAD;
    invalidCompletionCoroutine.returnedObject = @"bad-completion";
    invalidCompletionTask.coroutine = invalidCompletionCoroutine;
    unsupportedYieldCoroutine.status = AsyncCoroutineStatus_SUSPENDED;
    ...
    [scheduler _enqueueTask: (AsyncTask *)resolvedTask];
    [scheduler _resumeTask: (AsyncTask *)resolvedTask];

    [scheduler shutdown];
    [scheduler _enqueueTask: (AsyncTask *)shutDownTask];
    ...
    [scheduler _resumeTask: (AsyncTask *)invalidCompletionTask];
    [scheduler _resumeTask: (AsyncTask *)unsupportedYieldTask];
    ...
    async_current_task = (AsyncTask *)otherOwnerTask;
    @try {
        [taskGroup spawnTask: ^id {
            return @"mismatch";
        }];
    ...
    @try {
        [cancelledTaskGroup _registerChildTask: (AsyncTask *)ownerTask];
    } @catch (OFInvalidArgumentException *) {
        caughtRegisterAfterCancel = true;
    }

    @try {
        [finishedTaskGroup _registerChildTask: (AsyncTask *)ownerTask];
    } @catch (OFInvalidArgumentException *) {
    ...
    OTAssert((invalidCompletionTask.rejectCount == 1
        and [invalidCompletionTask.failureException isKindOfClass: AsyncTaskReturnedNilException.class]), @"Schedulers should reject dead coroutines that return invalid completion objects");
    ...
    OTAssert((caughtSpawnOutsideTask
        ...
        and caughtDeadlineSchedulerMismatch), @"AsyncTask groups should reject spawn, child-task-group, and deadline helpers outside the owning task scheduler");
...
#pragma clang diagnostic pop
    ...
    OTAssert(([some isEqual: some]
        ...
        and not [some isEqual: [OFNumber numberWithInt: 42]]), @"Optional equality should cover self, raw-value, nil, and type-mismatch comparisons");
