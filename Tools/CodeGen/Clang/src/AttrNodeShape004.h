...
@interface AttrNodeShape004 : OFObject <JSONDeserialisable>
...
@property(readonly, nonatomic) OFString *nillable message;
@property(readonly, nonatomic) SourceRange *range;
@property(readonly, nonatomic) OFString *nillable replacement;
