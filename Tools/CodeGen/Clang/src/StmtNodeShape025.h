...
@interface StmtNodeShape025 : OFObject <JSONDeserialisable>
@property(readonly, nonatomic) OFArray<AstObject *> *nillable array_filler;
@property(readonly, nonatomic) BareDeclRef *nillable field;
