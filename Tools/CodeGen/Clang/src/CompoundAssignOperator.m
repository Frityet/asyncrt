...
@implementation CompoundAssignOperator
...
- (instancetype)initFromJSONObject: (id)obj
{
    ...
    {
        auto value = dictionary[@"computeLHSType"];
        _computeLHSType = [[JSONQualType alloc] initFromJSONObject: $assert_nonnil(value)];
    }
    {
        auto value = dictionary[@"computeResultType"];
        _computeResultType = [[JSONQualType alloc] initFromJSONObject: $assert_nonnil(value)];
    }
    {
    ...
    {
        auto value = dictionary[@"opcode"];
        _opcode = $cast(OFString, $assert_nonnil(value));
    }
    {
