...
@implementation VarTemplatePartialSpecializationDecl
...
- (instancetype)initFromJSONObject: (id)obj
{
    ...
    {
        auto value = dictionary[@"explicitObjectParameter"];
        if (value != nilptr)
            _explicitObjectParameter = [$cast(OFNumber, value) boolValue];
    }
    {
    ...
    {
        auto value = dictionary[@"init"];
        if (value != nilptr)
            _jsonInit = $cast(OFString, value);
    }
    {
    ...
    {
        auto value = dictionary[@"isParameterPack"];
        if (value != nilptr)
            _isParameterPack = [$cast(OFNumber, value) boolValue];
    }
    {
    ...
    {
        auto value = dictionary[@"modulePrivate"];
        if (value != nilptr)
            _modulePrivate = [$cast(OFNumber, value) boolValue];
    }
    {
    ...
    {
        auto value = dictionary[@"nrvo"];
        if (value != nilptr)
            _nrvo = [$cast(OFNumber, value) boolValue];
    }
    {
    ...
    {
        auto value = dictionary[@"tls"];
        if (value != nilptr)
            _tls = $cast(OFString, value);
    }
    {
