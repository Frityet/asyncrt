...
@interface DeclNodeShape008 : OFObject <JSONDeserialisable>
...
@property(readonly, nonatomic) JSONQualType *nillable fixedUnderlyingType;
...
@property(readonly, nonatomic) OFString *nillable scopedEnumTag;
