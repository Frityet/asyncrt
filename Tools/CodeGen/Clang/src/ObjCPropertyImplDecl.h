...
@interface ObjCPropertyImplDecl : OFObject <JSONDeserialisable>
@property(readonly, nonatomic) OFString *nillable firstRedecl;
@property(readonly, nonatomic) OFString *id;
@property(readonly, nonatomic) OFString *implKind;
...
@property(readonly, nonatomic) BareDeclRef *ivarDecl;
...
@property(readonly, nonatomic) BareDeclRef *propertyDecl;
