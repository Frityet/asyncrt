...
@implementation ObjCPropertyImplDecl
...
- (instancetype)initFromJSONObject: (id)obj
{
    ...
    {
        auto value = dictionary[@"implKind"];
        _implKind = $cast(OFString, $assert_nonnil(value));
    }
    {
    ...
    {
        auto value = dictionary[@"ivarDecl"];
        _ivarDecl = [[BareDeclRef alloc] initFromJSONObject: $assert_nonnil(value)];
    }
    {
    ...
    {
        auto value = dictionary[@"propertyDecl"];
        _propertyDecl = [[BareDeclRef alloc] initFromJSONObject: $assert_nonnil(value)];
    }
    {
