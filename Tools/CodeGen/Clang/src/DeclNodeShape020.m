...
@implementation DeclNodeShape020
...
- (instancetype)initFromJSONObject: (id)obj
{
    ...
    {
        auto value = dictionary[@"instance"];
        _instance = [$cast(OFNumber, $assert_nonnil(value)) boolValue];
    }
    {
    ...
    {
        auto value = dictionary[@"returnType"];
        _returnType = [[JSONQualType alloc] initFromJSONObject: $assert_nonnil(value)];
    }
    {
