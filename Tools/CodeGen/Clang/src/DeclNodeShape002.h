...
@interface DeclNodeShape002 : OFObject <JSONDeserialisable>
...
@property(readonly, nonatomic) bool isNested;
...
@property(readonly, nonatomic) BareDeclRef *nillable originalNamespace;
