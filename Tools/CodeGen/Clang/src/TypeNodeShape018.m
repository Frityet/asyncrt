...
@implementation TypeNodeShape018
...
- (instancetype)initFromJSONObject: (id)obj
{
    ...
    {
        auto value = dictionary[@"typeKeyword"];
        _typeKeyword = $cast(OFString, $assert_nonnil(value));
    }
    {
        auto value = dictionary[@"undeduced"];
        _undeduced = [$cast(OFNumber, $assert_nonnil(value)) boolValue];
    }
