...
@interface ArrayParameterType : OFObject <JSONDeserialisable>
...
@property(readonly, nonatomic) OFString *nillable indexTypeQualifiers;
...
@property(readonly, nonatomic) OFNumber *size;
@property(readonly, nonatomic) OFString *nillable sizeModifier;
