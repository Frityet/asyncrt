...
@interface StmtNodeShape033 : OFObject <JSONDeserialisable>
@property(readonly, nonatomic) OFString *id;
@property(readonly, nonatomic) OFString *nillable jsonInitStyle;
...
@property(readonly, nonatomic) bool isPlacement;
@property(readonly, nonatomic) OFString *kind;
@property(readonly, nonatomic) BareDeclRef *nillable operatorDeleteDecl;
@property(readonly, nonatomic) BareDeclRef *nillable operatorNewDecl;
