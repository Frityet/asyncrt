...
@interface ObjCCategoryImplDecl : OFObject <JSONDeserialisable>
@property(readonly, nonatomic) BareDeclRef *categoryDecl;
...
@property(readonly, nonatomic) BareDeclRef *interface;
