...
@interface CompoundAssignOperator : OFObject <JSONDeserialisable>
@property(readonly, nonatomic) JSONQualType *computeLHSType;
@property(readonly, nonatomic) JSONQualType *computeResultType;
