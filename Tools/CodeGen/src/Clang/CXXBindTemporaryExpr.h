...
@interface CXXBindTemporaryExpr : OFObject <JSONDeserialisable>
@property(readonly, nonatomic) BareDeclRef *nillable dtor;
...
@property(readonly, nonatomic) OFString *temp;
