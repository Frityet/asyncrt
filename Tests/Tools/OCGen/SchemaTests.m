...
- (void)testGeneratesObjCInterfaceList
{
    ...
    @try {
        ...
        OTAssertTrue([header containsString: @"#import \"Tools/OCGen/src/Schema.h\""],
...
{
    auto sourcePath = [self _projectPath: @"Tests/Tools/OCGen/Fixtures/verify.c"];
    auto schemaPath = [self _projectPath: @"clang.schema.json"];
    auto process = [OFSubprocess subprocessWithProgram: @"clang-22"
...
{
    auto sourcePath = [self _projectPath: @"Tests/Tools/OCGen/Fixtures/verify.m"];
    auto schemaPath = [self _projectPath: @"clang.schema.json"];
    auto process = [OFSubprocess subprocessWithProgram: @"clang-22"
