package("llvm-mingw")
    ...
    elseif is_host("macosx") then
        set_urls("https://github.com/mstorsjo/llvm-mingw/releases/download/$(version)/llvm-mingw-$(version)-ucrt-macos-universal.tar.xz")

        -- Upstream only ships macOS host binaries starting with 20220323.
        add_versions("20220323", "5ccfd9ebe3ecf4b1f682cc3303af93e70b7977c86e32faa8e0c212e8f674b8cd")
        add_versions("20240417", "76823b955e7c761457c39bdd3b690aa870f9bf512fbbc0392d986a9d9fb5ee27")
    end

    on_install("@windows", "@linux|x86_64", "@linux|arm64", "@macosx", function (package)
        -- Preserve Unix toolchain symlinks such as clang++ -> clang.
